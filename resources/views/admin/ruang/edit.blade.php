                ...
                <div class="card-body">
                    <form action="{{ route('admin.ruang.update', $ruang->id_ruang) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_ruang') is-invalid @enderror" id="nama_ruang" name="nama_ruang" value="{{ old('nama_ruang', $ruang->nama_ruang) }}" required>
                            @error('nama_ruang')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('kapasitas') is-invalid @enderror" id="kapasitas" name="kapasitas" value="{{ old('kapasitas', $ruang->kapasitas) }}" min="1" required>
                            @error('kapasitas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="kosong" {{ old('status', $ruang->status) == 'kosong' ? 'selected' : '' }}>Kosong</option>
                                <option value="dipakai" {{ old('status', $ruang->status) == 'dipakai' ? 'selected' : '' }}>Dipakai</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3 pengguna-default-fields" id="penggunaDefaultFields" style="display: none;">
                            ...
                            <input type="text" class="form-control @error('pengguna_default') is-invalid @enderror" id="pengguna_default" name="pengguna_default" value="{{ old('pengguna_default', $ruang->pengguna_default) }}" placeholder="Contoh: Kelas 10A, Guru Matematika, dll">
                        ...
                        <div class="mb-3 pengguna-default-fields" id="keteranganPenggunaanFields" style="display: none;">
                            ...
                            <textarea class="form-control @error('keterangan_penggunaan') is-invalid @enderror" id="keterangan_penggunaan" name="keterangan_penggunaan" rows="3" placeholder="Jelaskan penggunaan ruangan ini secara default">{{ old('keterangan_penggunaan', $ruang->keterangan_penggunaan) }}</textarea>
